...
def get_parser():
    ...
    parser.add_argument('--compute_environment', default='GPU')
    parser.add_argument('--debug', default=True)
    parser.add_argument('--distributed_type', default=None)
    parser.add_argument('--downcast-bf16', default=None)
    parser.add_argument('--gpu-ids', default=None)
    parser.add_argument('--machine-rank', default=None)
    parser.add_argument('--main_training_function', default=None)
    parser.add_argument('--mixed_precision',default=None)
    parser.add_argument('--num_machines', default=1)
    parser.add_argument('--num_processes', default=None)

    parser.add_argument('--rdzv_backend', default=None)
    parser.add_argument('--same_network', default=None)
    parser.add_argument('--tpu_env', default=None)
    parser.add_argument('--tpu_use_cluster', default=None)
    parser.add_argument('--tpu_use_sudo', default=None)
    parser.add_argument('--use_cpu', default=None)
